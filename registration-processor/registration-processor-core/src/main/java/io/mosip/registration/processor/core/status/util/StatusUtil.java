...
public enum StatusUtil {
    ...
    BIO_DEDUPE_ALL_BIOMETRIC_EXCEPTION(StatusConstants.BIO_DEDUPE_MODULE_FAILED + "002",
            "All Biometric having Exception"),
	BIO_DEDUPE_NO_BIOMETRICS_FOUND(StatusConstants.BIO_DEDUPE_MODULE_FAILED + "003",
